...
import com.tglt.notepad.android.NotepadActivity;
import com.tglt.notepad.old.fragment.NoteEditFragment;
import com.tglt.notepad.old.fragment.NoteListFragment;
import com.tglt.notepad.old.fragment.NoteViewFragment;
import com.tglt.notepad.old.fragment.WelcomeFragment;
...
import com.tglt.notepad.old.fragment.dialog.FirstRunDialogFragment;
import com.tglt.notepad.old.fragment.dialog.SaveButtonDialogFragment;
import com.tglt.notepad.old.util.WebViewInitState;
...
NoteViewFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getPackageManager().getComponentEnabledSetting( new ComponentName(this, NotepadActivity.class) ) == PackageManager.COMPONENT_ENABLED_STATE_ENABLED) {
...
//            fragment.onBackPressed();
    ...
    // Loads note from /data/data/com.tglt.notepad.old/files
